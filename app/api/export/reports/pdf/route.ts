  ...
  const sections = [
    {
      ...
      rows: [
        ...
        { label: "Biaya produksi periode", value: currency.format(report.production.cost) },
        { label: "Revenue panen periode", value: currency.format(report.production.revenue) },
        { label: "Revenue - biaya periode", value: currency.format(report.production.profit), emphasis: true },
        { label: "Margin final", value: pct(report.production.marginPct) },
      ],
    },
    {
