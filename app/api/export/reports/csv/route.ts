...
export async function GET(request: Request): Promise<Response> {
  ...
  const rows: unknown[][] = [
    ...
    ["production", "cost", report.production.cost, "IDR"],
    ["production", "revenue", report.production.revenue, "IDR"],
    ["production", "profit", report.production.profit, "IDR"],
    ["production", "margin", report.production.marginPct ?? "", "%"],
