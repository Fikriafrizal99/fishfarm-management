      ...
      <div className="opsPage operationWorkspacePage">
        ...
        <div className="workspaceSplit operationSplit">
          <form action={submitHarvest} className="workspaceCard operationalWorkspaceForm">
            ...
            <div className="formSectionBlock"><h3>Hasil panen</h3><div className="compactFieldGrid two"><label><span>Berat panen</span><div className="compactUnitInput"><input name="weightKg" type="number" min="0.001" step="0.001" placeholder="810" required /><b>kg</b></div></label><label><span>Jumlah ikan</span><div className="compactUnitInput"><input name="fishCount" type="number" min="1" step="1" /><b>ekor</b></div></label><label><span>Harga realisasi/kg <em className="fieldTag">transisi</em></span><div className="compactUnitInput money"><b>Rp</b><input name="sellingPricePerKg" type="number" min="1" step="1" placeholder="23000" required /></div></label><label><span>Biaya panen</span><div className="compactUnitInput money"><b>Rp</b><input name="harvestCost" type="number" min="0" step="1" placeholder="0" /></div></label></div></div>
            <div className="formSectionBlock"><h3>Catatan komersial transisi</h3><label><span>Pembeli langsung <em className="fieldTag">legacy</em></span><input name="buyerName" placeholder="Kosongkan jika dikelola lewat Sales CRM" /></label><label><span>Catatan panen</span><textarea name="notes" rows={3} /></label></div>
          ...
          <aside className="operationContextStack"><section className="workspaceCard operationContextCard"><div className="workspaceCardHeader"><div><span>INTEGRITY POLICY</span><h2>Setelah tersimpan</h2></div></div><div className="contextMetricList"><div><span>Harvest</span><strong>Immutable event</strong></div><div><span>HarvestLot</span><strong>Auto-created</strong></div><div><span>Fulfillment</span><strong>Commercial allocation</strong></div><div><span>Koreksi</span><strong>Via adjustment flow nanti</strong></div></div><p className="metricDisclaimer">Panen tidak diedit langsung karena dapat sudah terhubung ke HarvestLot dan transaksi Sales CRM.</p></section></aside>
        </div>
